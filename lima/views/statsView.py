...
def estatisticas(request):
    ...
    return render(request, 'stats/estatisticas.html', {'footer': footer,'clientes': clientes, 'tratamientos': tratamientos,'facturacion': facturacion,'tecnicas_horarios':tecnicas_horarios,'form': form, 'citas': citas})
...
def estadisticas_horario_tecnica(request, pk=0):
    ...
    return render(request, 'stats/estadistica_horario.html', {'footer': footer,'tiempo': tiempo,'timeMonth': timeMonth, 'form': form})